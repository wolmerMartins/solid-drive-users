...
const REENABLE_USER_CODE = 'reenableUser'
...
const ENABLED_ALREADY = 'enabledAlready'
...
const REENABLE_REQUIRED_PARAMETERS = [USERNAME_FIELD]
...
const CODES = {
  ...
  [REENABLE_TYPE]: {
    [MISSING_PARAMETER_CODE]: 'reenable0',
    [REENABLE_USER_CODE]: 'reenable1'
  }
}
const MESSAGES = {
  ...
  [REENABLE_USER_CODE]: 'Reenable user error',
  [ENABLED_ALREADY]: 'Is not disabled'
}
...
exports.REENABLE_TYPE = REENABLE_TYPE
...
exports.ENABLED_ALREADY = ENABLED_ALREADY
...
exports.REENABLE_USER_CODE = REENABLE_USER_CODE
...
exports.REENABLE_REQUIRED_PARAMETERS = REENABLE_REQUIRED_PARAMETERS
